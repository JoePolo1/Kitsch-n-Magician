...
export default function DayofTheWeek(props) {
  ...
  return (
    <Box sx={{ flexGrow: 0, 
      ...
      bgcolor: '#CBF5EF'}} >
        <Box sx={{ flexGrow: 0, width: 239, display: 'flex', alignItems: 'left', justifyContent: 'center', flexDirection: 'column', pl: '1em', bgcolor:'#88E3D3'}}>
          <p>{props.day}:</p>
        </Box>

        {matchFound ? 
          <Box sx={{ flexGrow: 0, width: 239, pt: '0.2em', pb: '0.2em', pl: '0.5em', display: 'flex', alignItems: 'center', minHeight: '3.5em', justifyContent: 'center', flexDirection: 'column', bgcolor: '#CAF4DA'}}>
